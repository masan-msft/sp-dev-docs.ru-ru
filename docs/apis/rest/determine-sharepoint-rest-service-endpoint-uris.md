...
**Структура синтаксиса для URI конечных точек REST в SharePoint**
![Синтаксис запросов REST в SharePoint](../../../images/REST_OverallSyntax.png)
...
На приведенном ниже рисунке показан синтаксис параметров REST в SharePoint.
 
**Синтаксис параметров REST в SharePoint**
![Синтаксис параметров метода для службы REST в SharePoint](../../../images/REST_parameterSyntax.png)
...
**Синтаксис псевдонимов для параметров службы REST в SharePoint**
![Синтаксис псевдонимов для параметров службы REST в SharePoint](../../../images/REST_parameterAliasSyntax.png)
...
![Синтаксис службы REST для параметров словарей](../../../images/REST_parameterDictionarySyntax.png)
...
![Синтаксис службы REST для параметров в строке запроса](../../../images/REST_parameterQuerySyntax.png)
...
![Синтаксис статического элемента для службы REST](../../../images/REST_parameterQuerySyntax.png)

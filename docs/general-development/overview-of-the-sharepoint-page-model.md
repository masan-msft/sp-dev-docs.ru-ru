...
## <a name="introduction-to-the-page-model"></a>Общие сведения о модели страницы
...
## <a name="master-pages-page-layouts-and-pages"></a>Эталонные страницы, макеты страниц и страницы
...
### <a name="page-field-controls"></a>Элементы управления полями страницы
...
### <a name="relationship-of-master-pages-and-page-layouts"></a>Отношение эталонных страниц и макетов страниц
...
## <a name="search-driven-web-parts-and-display-templates"></a>Веб-части на основе поиска и шаблоны для отображения
...
### <a name="search-driven-web-parts"></a>Веб-части на основе поиска
...
В SharePoint есть несколько готовых шаблонов отображения, например списки и слайд-шоу для веб-частей поиска контента. Шаблоны отображения можно выбрать во время настройки веб-части поиска контента в браузере.
  
    
    

**Рис. 14. Область инструментов веб-части поиска контента**
...
### <a name="control-display-template"></a>Шаблон отображения элемента управления
...
### <a name="item-display-template"></a>Шаблон отображения элемента
...
## <a name="device-channels-and-device-channel-panels"></a>Каналы устройств и панели канала устройств

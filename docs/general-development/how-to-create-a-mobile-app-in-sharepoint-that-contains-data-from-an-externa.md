...
---
# <a name="create-a-mobile-app-in-sharepoint-that-contains-data-from-an-external-data-source"></a>Создание мобильного приложения в SharePoint, который содержит данные из внешнего источника данных

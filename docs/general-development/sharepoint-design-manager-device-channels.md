...
---
# <a name="sharepoint-design-manager-device-channels"></a>Каналы устройств в компоненте "Дизайнер" SharePoint
Сведения о настройке и планировании использования каналов устройств на сайте SharePoint.
## <a name="introduction-to-device-channels"></a>Общие сведения о каналах устройств
<a name="Int"> </a>
...
Каналы устройств доступны только для сайтов публикации SharePoint. Прежде чем реализовывать каналы устройств, необходимо получить общее представление о функции "Дизайнер", о том, из чего состоит сайт SharePoint и как создать страницу SharePoint. Дополнительные сведения о модели страницы SharePoint, а также об эталонных страницах и макетах страниц см. в статье  [Обзор модели страниц в SharePoint](overview-of-the-sharepoint-page-model.md). Дополнительные сведения о компоненте "Дизайнер" см. в статье  [Обзор Дизайнера в SharePoint](overview-of-design-manager-in-sharepoint.md).
  
    
    

## <a name="what-is-a-device-channel"></a>Что такое канал устройств?
<a name="WhatDev"> </a>
...
> **Примечание.** Дополнительные сведения и инструкции по созданию канала устройств см. в разделе [Создание канала устройств](sharepoint-design-manager-device-channels.md#create) этой статьи.
...
### <a name="user-agent-substrings-and-device-channel-rankings"></a>Подстроки агента пользователя и ранжирование каналов устройств
...
> **Примечание.** Дополнительные сведения об изменении порядка каналов устройств см. в разделе [Создание канала устройств](sharepoint-design-manager-device-channels.md#create) этой статьи.
  
    
    


**Таблица 3. Пример расположения каналов устройств**
...
> **Примечание.** Дополнительные сведения и инструкции по расположению каналов устройств см. в разделе [Изменение порядка каналов устройств](sharepoint-design-manager-device-channels.md#reorder) этой статьи.
  
    
    


### <a name="device-channel-panels"></a>Панели каналов устройств
<a name="PlanDeviceChannels_UserAgentSubstrings"> </a>
...
### <a name="what-site-experience-am-i-trying-to-achieve-across-the-desktop-and-my-devices"></a>Как сайт в результате должен отображаться на компьютере и других устройствах?
...
Первая ваша задача  записать, что нужно реализовать, чтобы создать удобный пользовательский интерфейс для различных устройств. Каких возможностей целевая аудитория пользователей ждет от сайта публикации SharePoint на компьютере, телефоне, планшете? Можно обнаружить различные проблемы, включая возможные ограничения и особенности, связанные с отдельными устройствами, которые необходимо учитывать. Запишите всю эту информацию в любом формате. Это поможет вам понять конкретные цели, которых нужно достичь с помощью каналов устройств, и ответить на последовательные вопросы, перечисленные ниже (например, какие устройства должны поддерживаться и сколько нужно каналов устройств).
...
### <a name="how-many-device-channels-do-you-need"></a>Сколько каналов устройств нужно?
...
### <a name="where-is-a-list-of-all-of-the-device-substrings-i-can-use"></a>Где найти список всех возможных подстрок устройств?
...
> **Примечание.** Ниже приведены примеры, а не настоящие строки для указанных устройств с Windows. Они предназначены для иллюстрации того, как выделить подстроку. 
  
    
    


**Таблица 4. Использование разных строк для разных агентов пользователя**
...
### <a name="do-i-need-to-use-device-channel-panels"></a>Нужно ли использовать панели каналов устройств?
...
### <a name="can-i-use-cookies-to-select-a-device-channel"></a>Можно ли использовать файлы cookie для выбора канала устройств?
...
## <a name="create-a-device-channel"></a>Создание канала устройств
<a name="create"> </a>
...
### <a name="to-create-a-device-channel"></a>Чтобы создать канал устройств:
...
## <a name="change-a-device-channel"></a>Изменение канала устройств
<a name="modify"> </a>
...
> **Примечание.** Канал по умолчанию нельзя изменить. 
  
    
    


### <a name="to-change-a-device-channel"></a>Чтобы изменить канал устройств:
...
6. Чтобы изменить псевдоним канала устройств, введите новый псевдоним в поле **Псевдоним**.
    
    > **Примечание.** Если вы измените псевдоним канала устройств, его нужно будет вручную изменить в других местах, где он используется, например в пользовательском коде или разметке. Также нужно будет изменить сопоставления между каналом устройств и эталонными страницами. 
7. Чтобы изменить описание канала устройств, введите новое описание в поле **Описание**.
...
## <a name="delete-a-device-channel"></a>Удаление канала устройств
<a name="delete"> </a>
...
> **Примечание.** Канал по умолчанию нельзя удалить. 
  
    
    


### <a name="to-delete-a-device-channel"></a>Чтобы удалить канал устройств:
...
## <a name="change-the-order-of-device-channels"></a>Изменение порядка каналов устройств
<a name="reorder"> </a>
...
### <a name="to-reorder-device-channels"></a>Чтобы изменить порядок каналов устройств:

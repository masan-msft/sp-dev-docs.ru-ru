...
5. В диалоговом окне **Выбор актива** найдите и выберите преобразуемый HTML-файл.
    ...
    > **Примечание.** При отправке файлов оформления следует хранить все файлы, связанные с одним оформлением, в отдельной папке в коллекции эталонных страниц. Если скопировать папку оформления на сопоставленный сетевой диск, в коллекции эталонных страниц сохранится созданная вами структура папок. 

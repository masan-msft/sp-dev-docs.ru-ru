...
---
# <a name="build-windows-phone-apps-that-access-sharepoint"></a>Построение приложений Windows Phone, обращающимися к SharePoint

...
---
# <a name="query-refinement-in-sharepoint"></a>Уточнение запроса в SharePoint
...
> **Примечание:** При указании уточнений, необходимо как минимум, для указания `refiner-name`, которая является управляемого свойства. 

...
> **Примечание:** Дополнительные сведения о сопоставлении сетевого диска можно [как: сопоставление сетевого диска коллекции SharePoint главных страниц](how-to-map-a-network-drive-to-the-sharepoint-master-page-gallery.md). 

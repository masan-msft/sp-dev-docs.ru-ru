...
<span data-ttu-id="0f596-182">На этом этапе можно запустить приложение и проверить его.</span><span class="sxs-lookup"><span data-stu-id="0f596-182">In this step, you can run your app and validate it.</span></span>

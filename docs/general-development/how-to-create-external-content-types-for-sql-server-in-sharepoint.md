...
> [!NOTE]
> Функция ферм и сайтов **Автономная синхронизация для внешних списков** также должна быть активна. По умолчанию эта функция включена на уровне фермы, но отключена на уровне сайта. 
...
1. В проводнике источника данных щелкните правой кнопкой мыши таблицу, представление или процедуру, а затем выберите одну из следующих команд:
  ...
  - **Создать все операции**. Определяет операции создания, удаления и чтения элемента, чтения списка и обновления элемента.
    ...
    > [!NOTE]
    > Команда **Создать все операции** доступна только для таблиц и представлений. Подпрограммам необходимы определенные операции.
...
> [!TIP]
> Всегда внимательно читайте сообщения в области **Ошибки и предупреждения**. Они содержат полезные сведения, касающиеся подтверждения действий и устранения возможных проблем. Периодически открывайте область **Ошибки и предупреждения**, чтобы убедиться, что ошибок и предупреждений больше нет.

...
### <a name="to-add-a-reference-to-microsoftofficeexcelwebuidll"></a>To add a reference to Microsoft.Office.Excel.WebUI.dll
...
2. Instantiate and initialize the Веб-клиент Excel Web Part, as follows:
...
The following example is a Windows Forms application that enables a user to enter information on a SharePoint site and display an Excel workbook saved in a trusted location programmatically. It programmatically creates an Веб-клиент Excel Web Part on the default.aspx page of the specified site and displays the specified Excel workbook.

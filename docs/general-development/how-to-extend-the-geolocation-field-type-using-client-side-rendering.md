...
---
# <a name="extend-the-geolocation-field-type-by-using-client-side-rendering"></a>Дополнение типа поля "Географическое положение" с использованием клиентской обработки

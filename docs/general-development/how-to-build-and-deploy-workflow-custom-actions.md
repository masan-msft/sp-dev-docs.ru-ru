...
---
# <a name="build-and-deploy-workflow-custom-actions"></a>Построение и развертывание настраиваемого действия рабочего процесса
...
> **Примечание:** Обеспечивает пример демонстрирует создание настраиваемых действий. Образец, а также файл readme доступен здесь: [рабочего процесса SharePoint: Создание настраиваемого действия](http://code.msdn.microsoft.com/SharePoint-2013-workflow-41e5c0f9) (http://code.msdn.microsoft.com/SharePoint-2013-workflow-41e5c0f9).

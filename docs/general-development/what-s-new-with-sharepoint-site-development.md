...
> **Примечание.** Пакет конструктора не включает страницы, параметры навигации и банк терминов. 
...
Дополнительные сведения о публикации на нескольких сайтах см. в статье [Сценарий: создание сайтов SharePoint с помощью публикации на нескольких сайтах в SharePoint](http://technet.microsoft.com/en-us/sharepoint/jj872721). Дополнительные сведения о вариантах разработки для публикации на нескольких сайтах см. в статье [Публикация на нескольких сайтах в SharePoint](cross-site-publishing-in-sharepoint.md).

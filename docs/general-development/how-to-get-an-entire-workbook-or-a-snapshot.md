...
Make sure you add a Web reference to an Веб-службы Excel site you have access to. Change the  `using GetSnapshot.myServer02;` statement to point to the Web service site you are referencing.

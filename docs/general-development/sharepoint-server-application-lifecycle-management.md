...
-  [<span data-ttu-id="3d850-448">Настройка службы сборки Team Foundation</span><span class="sxs-lookup"><span data-stu-id="3d850-448">Set up Team Foundation Build Service</span></span>](http://msdn.microsoft.com/ru-ru/library/vstudio/ee259687.aspx)

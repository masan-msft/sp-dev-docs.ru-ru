...
> [!NOTE] 
> Действие **InvokeSharePointWorkflow** представляет собой оболочку для метода CSOM [StartWorkflow](https://msdn.microsoft.com/library/Microsoft.SharePoint.Client.WorkflowServices.InteropService.StartWorkflow.aspx).
...
-  
  [Рабочие процессы в SharePoint](http://msdn.microsoft.com/en-us/library/jj163986.aspx)
    
  
-  
  [Что такое Workflow Manager 1.0?](http://msdn.microsoft.com/en-us/library/windowsazure/jj193471%28v=azure.10%29.aspx)

...
- Группы состоят из пользователей, и им могут назначаться или не назначаться роли. В состав SharePoint по умолчанию входят следующие три группы:
...
## <a name="users-groups-and-principals"></a>Пользователи, группы и субъекты
...
## <a name="high-level-view-of-object-relationsscopes-users-groups-and-roles"></a>Высокоуровневое представление связей объектов: области, пользователи, группы и роли
...
## <a name="user-tokens-and-access-control-lists"></a>Маркеры пользователей и списки управления доступом
...
## <a name="object-model-changes-obsolete-but-backward-compatible-security-objects"></a>Изменения объектной модели: устаревшие объекты безопасности с обратной совместимостью
...
### <a name="policy-roles-create-or-modify-security-policies-for-url-zones"></a>Роли политик: создание или изменение политик безопасности для зон URL-адресов
...
## <a name="guest-roles-limited-access-to-accommodate-shared-resources"></a>Гостевые роли (ограниченный доступ) для размещения общих ресурсов
...
### <a name="folder-and-item-extensions"></a>Расширения папок и элементов
...
## <a name="removing-users-from-a-scope-or-from-all-scopes"></a>Удаление пользователей из одной области или из всех областей

...
Сведения о возможности обнаружения электронных данных в SharePoint. Обнаружение электронных данных можно использовать для предоставления возможности для обнаружения контента в формате электронных litigators.
## <a name="introduction-to-ediscovery-in-sharepoint"></a>Общие сведения об обнаружении электронных данных в SharePoint
...
обнаружение электронных данных в SharePoint и имеются новые способы для сокращения затрат и сложности обнаружения. К ним относятся:
...
## <a name="how-ediscovery-works-in-sharepoint"></a>Как eDiscovery работает в SharePoint
...
## <a name="site-holds"></a>Содержит сайт
...
| **DiscoveryDuplicateSourceCollection** <br/> |Исключение, порождаемое, если значение объекта **Source** не является уникальным. <br/> |
...
-  [Новые возможности обнаружения электронных данных SharePoint и обеспечения соответствия требованиям](what-s-new-in-sharepoint-ediscovery-and-compliance.md)

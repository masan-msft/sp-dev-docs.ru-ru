...
6.  **УСЛУГИ ПОДДЕРЖКИ.** Так как это программное обеспечение предоставляется "как есть", мы может не предоставлять услуги поддержки для него.
    
 
7.  **Обратная связь.** Если условия использования не включают положение, относящееся к Отзывам, применяются указанные ниже условия.
  ...
  2.  **Сохранение прав. Права владения.** Согласно условиям явных лицензий, предоставляемых настоящим Соглашением, Поставщик Отзывов:
      ...
      1. сохраняет все права, правовые титулы и интересы касательно Отзывов;

# <a name="create-add-in-parts-to-install-with-your-sharepoint-add-in"></a>Создание веб-частей надстройки для установки совместно с надстройкой SharePoint
...
-  [Доступ к надстройке из пользовательского интерфейса](important-aspects-of-the-sharepoint-add-in-architecture-and-development-landscape#AccessingApp);
    
 
-  [Разработка пользовательского интерфейса для надстроек SharePoint](ux-design-for-sharepoint-add-ins);
    
 
-  [Расширение пользовательского интерфейса SharePoint в надстройках](sharepoint-add-ins-ux-design-guidelines#UXGuide_Extending).
...
- Среда разработки SharePoint. Если вам нужна помощь в настройке среды разработки, см. статью [Знакомство с созданием надстроек SharePoint с размещением у поставщика](get-started-creating-provider-hosted-sharepoint-add-ins).
...
1. Создайте надстройку SharePoint с размещением у поставщика, как описано в статье [Знакомство с созданием надстроек SharePoint с размещением у поставщика](get-started-creating-provider-hosted-sharepoint-add-ins), но с именем проекта "TestAppPart".
...
Вы можете загрузить [пример кода веб-части надстройки](http://code.msdn.microsoft.com/SharePoint-2013-Display-be8dac16), где показано, как использовать страницу SharePoint в качестве страницы содержимого.
...
-  [Пример кода. Отображение удаленного содержимого веб-страницы с помощью веб-части надстройки "Coffeemaker"](http://code.msdn.microsoft.com/SharePoint-2013-App-part-9d83703c)

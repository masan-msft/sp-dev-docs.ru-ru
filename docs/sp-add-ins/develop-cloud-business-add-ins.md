# <a name="develop-cloud-business-add-ins"></a><span data-ttu-id="d5f74-101">Разработка облачных бизнес-надстроек</span><span class="sxs-lookup"><span data-stu-id="d5f74-101">Develop cloud business add-ins</span></span>

...
Ознакомьтесь с разделом [Обработка событий надстройки](handle-events-in-sharepoint-add-ins#HandlingAppEvents) и статье [Обновление надстроек SharePoint](update-sharepoint-add-ins), а том числе с перечисленными в них предварительными требованиями и основными понятиями.
...
-  [Создание удаленного приемника событий в надстройках SharePoint](create-an-add-in-event-receiver-in-sharepoint-add-ins)

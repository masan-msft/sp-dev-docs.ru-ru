...
**Примечание**  В этом примере кода выполняется только на Office 365. 
...
**Примечание**  Если вы используете свойства профиля пользователя, настройте свойство для редактироваться пользователями. Метод, используемый в данном сценарии будет работать для свойств профиля пользователя. 

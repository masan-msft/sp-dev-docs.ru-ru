...
> [!NOTE] 
> Вы несете ответственность за обеспечение значения переведенный текст в файле ресурсов JavaScript. 
...
> [!IMPORTANT] 
> CSOM периодически добавлены новые функции. Если CSOM предоставляет новые функции для обновления веб-страницы или панели быстрого запуска заголовки ссылок, рекомендуется использовать новые возможности в CSOM вместо описанные здесь.

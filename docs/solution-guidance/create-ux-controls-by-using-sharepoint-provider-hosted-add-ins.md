...
**Примечание:**  Решение Visual Studio 2013 пример содержит модуль с именем «Фиктивное», чтобы убедиться, что при развертывании надстройки создает add-in web. Надстройка web является обязательным для междоменных вызовов.

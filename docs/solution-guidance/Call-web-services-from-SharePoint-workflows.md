...
**Примечание**  Не удается выполнить задачу, показанную в этом примере с помощью Visual Studio 2013. В этом примере предоставляет полезные обходной путь. Если в будущем обновляются набора средств Visual Studio, не может потребоваться использовать этот способ.

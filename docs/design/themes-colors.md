...
description: "Принципы дизайна, которое легли в основу текущих тем и цветовой палитры SharePoint."
ms.date: 01/24/2018
...
Как и палитра торговой марки Microsoft, темы SharePoint основаны на фирменном стиле Майкрософт, но в то же время обеспечивают гибкость, позволяющую поддерживать ваши отношения с клиентами без лишних ограничений. Они раскрывают общие цели и особенности, а также отражают многообразие и возможности оптимизации среды SharePoint.

<br/>

![Цветовая палитра SharePoint: красный (D13438), оранжевый (CA5010), зеленый (10893E), синий (0078D7), сиреневый (6B69D6), серый (5D5A5B) ](../images/design-theme-colors.png)

## <a name="themes"></a>Темы

Приведенные ниже принципы дизайна легли в основу текущих тем и цветовой палитры SharePoint.

**Управляемые**. Наша система управления темами работает на глобальном уровне, поэтому пользователи могут вносить одинаковые изменения на разных сайтах, без проблем оптимизируя их. Наша система настройки темы работает в управляемой среде, что ускоряет оптимизацию успешных результатов.

**Продуманные и эффективные**. Наша система настройки темы ускоряет создание сайтов, используя интеллектуальные алгоритмы для подбора наиболее привлекательных вариантов.

**Профессиональные**. Наши темы имеют профессиональный внешний вид, который гарантирует целостность и передает индивидуальность наших корпоративных клиентов.

**Доступные**. Встроенное средство проверки читаемости обеспечивает универсальный дизайн на всех уровнях стандартных тем. Для пользователей, предпочитающих настраивать темы, мы предоставляем полезные рекомендации по созданию доступного оформления.

## <a name="colors"></a>Цвета

Цветовая палитра SharePoint оптимизирована для различных экранов и устройств, а также обеспечивает достаточную гибкость, позволяющую вам учитывать свой фирменный стиль. Цвета, предоставленные средой SharePoint, также гарантируют доступность и удобочитаемость.

### <a name="red"></a>Красная

![Красная цветовая палитра SharePoint D1343](../images/themes-colors-red-theme.png)
...
![Оранжевая цветовая палитра SharePoint CA5010](../images/themes-colors-orange-theme.png)
...
![Зеленая цветовая палитра SharePoint 10893E](../images/themes-colors-green-theme.png)
...
![Синяя цветовая палитра SharePoint 0078D7](../images/themes-colors-blue-theme.png)
...
![Сиреневая цветовая палитра SharePoint 6B69D6](../images/themes-colors-purple-theme.png)
...
![Серая цветовая палитра SharePoint 5D5A5B](../images/themes-colors-gray-theme.png)

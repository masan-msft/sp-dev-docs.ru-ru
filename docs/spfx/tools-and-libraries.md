...
* [Angular 2 для TypeScript 2.x](https://angular.io/guide/quickstart);
...
* [Документация по Webpack](https://webpack.js.org/)
...
[Yeoman](http://yeoman.io/) помогает начинать новые проекты, предоставляя рекомендации и инструменты для продуктивной работы. Генератор Yeoman для SharePoint входит в состав платформы и позволяет создавать новые клиентские веб-части. 
...
## <a name="sharepoint-rest-apis"></a>REST API SharePoint
...
* [REST API для списков SharePoint](../sp-add-ins/working-with-lists-and-list-items-with-rest.md).
...
- [Цепочка инструментов SharePoint Framework](toolchain/sharepoint-framework-toolchain.md)

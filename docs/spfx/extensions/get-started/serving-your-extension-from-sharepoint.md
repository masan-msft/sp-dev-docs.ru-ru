...
Поздравляем, вы развернули расширение на современной странице SharePoint из каталога приложений! Вы можете продолжить создавать расширение Hello World в следующей статье [Размещение расширения из сети доставки содержимого Office 365 (Hello World, часть 4)](./hosting-extension-from-office365-cdn.md). Работая с этой статьей, вы научитесь развертывать ресурсы расширения в сети CDN, а не в localhost, и загружать их из нее.

...
3. Далее вам потребуется развернуть созданный пакет в каталоге приложений. Для этого перейдите в **каталог приложений** клиента и откройте библиотеку **Приложения для SharePoint**.
...
Поздравляем, вы развернули расширение для современной страницы SharePoint в каталоге приложений! 

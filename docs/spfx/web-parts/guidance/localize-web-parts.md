...
>**Примечание.** К сожалению, на данный момент в системе разработки SharePoint невозможно просмотреть локализованные значения из манифеста веб-части. Всегда используется перевод по умолчанию.

...
Чтобы помочь организациям управлять настройками, корпорация Майкрософт добавила возможность работы без скриптов в SharePoint Online. Если в клиенте или определенном семействе веб-сайтов установлен флаг работы без скриптов, то настройки, использующие вставку и внедрение скриптов, отключаются.

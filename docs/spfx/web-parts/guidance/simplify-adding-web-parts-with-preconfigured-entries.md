...
groupId                 |string          |да     |Идентификатор группы определяет, в какой группе панели элементов будет отображаться веб-часть. Клиентская платформа имеет зарезервированные идентификаторы для предварительно определенных групп. Разработчик может выбрать одну из них.|`"groupId": "cf066440-0614-43d6-98ae-0b31cf14c7c3"`
группа                   |ILocalizedString|нет      |Это поле используется, чтобы определить, в какой группе панели элементов будет отображаться веб-часть в режиме редактирования. На классических страницах веб-часть с коллекцией — эквивалент панели элементов. При выборе GUID как идентификатора группы (как показано в таблице ниже), используйте имя категории соответствующей классической страницы из предварительно определенной группы.|`"group": { "default": "Media and Content" }`
...
Имя категории |Guid |Имя категории соответствующей классической страницы |Описание        
--- |--- |--- |---
Текст, мультимедиа и контент | `cf066440-0614-43d6-98ae-0b31cf14c7c3`| Мультимедиа и контент  |Эта категория включает веб-части, отображающие текст, мультимедиа, документы, информацию из сети и другой форматированный контент.   

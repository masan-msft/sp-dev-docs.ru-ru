...
группа                   |ILocalizedString|нет      |Имя группы в средстве выбора веб-частей должно содержать веб-часть на классической странице. Если значение не указано, веб-часть отображается в группе **Пользовательские**.|`"group": { "default": "Content", "nl-nl": "Inhoud" }`

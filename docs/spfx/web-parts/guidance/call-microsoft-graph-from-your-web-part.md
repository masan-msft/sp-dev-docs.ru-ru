...
> **Важно!** Приведенные ниже рекомендации основаны на ADAL JS версии 1.0.12. Добавляя ADAL JS к проектам SharePoint Framework, убедитесь, что вы устанавливаете ADAL JS версии 1.0.12. В противном случае представленные в этой статье рекомендации не будут работать надлежащим образом.
...
- [Сценарии аутентификации для Azure AD](https://Azure.microsoft.com/en-us/documentation/articles/active-directory-authentication-scenarios/)
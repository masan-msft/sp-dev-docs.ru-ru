...
- Разработчикам веб-частей необходимо явно указывать зависимость от библиотеки Fabric React версии 2.0 в файле **package.json**: `"office-ui-fabric-react":"2.34.2"`. Обратите внимание, что Fabric React версий выше 2.x не поддерживается.

# <a name="notes-on-solution-packaging"></a><span data-ttu-id="1573d-101">Примечания к пакету решений</span><span class="sxs-lookup"><span data-stu-id="1573d-101">Notes on solution packaging</span></span>

...
Пакет npm с SharePoint Framework Fabric Core **([@microsoft/sp-office-ui-fabric-core](https://www.npmjs.com/package/@microsoft/sp-office-ui-fabric-core))** содержит поддерживаемые стили Fabric Core, которые можно безопасно использовать в компоненте SharePoint Framework. 

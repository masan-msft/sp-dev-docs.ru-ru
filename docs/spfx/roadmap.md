# <a name="sharepoint-framework-roadmap"></a><span data-ttu-id="a0a20-101">План развития SharePoint Framework</span><span class="sxs-lookup"><span data-stu-id="a0a20-101">SharePoint Framework roadmap</span></span>

...
> **Важно!** Так как перед публикацией на сайте npmjs.com пакет не проходит официальную проверку, то перед использованием пакета тщательно изучите его содержимое и лицензию.

...
<span data-ttu-id="cce87-133">Этот интерфейс предоставляет следующие методы.</span><span class="sxs-lookup"><span data-stu-id="cce87-133">This interface exposes the following methods.</span></span>

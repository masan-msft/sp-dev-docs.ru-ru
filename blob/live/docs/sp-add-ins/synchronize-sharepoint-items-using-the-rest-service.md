...
|<span data-ttu-id="bc52a-128">**Query**</span><span class="sxs-lookup"><span data-stu-id="bc52a-128">**Query**</span></span>|<span data-ttu-id="bc52a-129">Элемент [Query](http://msdn.microsoft.com/en-us/library/ms471093.aspx), содержащий запрос, который определяет, какие записи возвращаются и в каком порядке.</span><span class="sxs-lookup"><span data-stu-id="bc52a-129">A  [Query](http://msdn.microsoft.com/en-us/library/ms471093.aspx) element containing the query that determines which records are returned and in what order.</span></span>|
...
|<span data-ttu-id="bc52a-136">**Contains**</span><span class="sxs-lookup"><span data-stu-id="bc52a-136">**Contains**</span></span>|<span data-ttu-id="bc52a-137">Элемент [Contains](http://msdn.microsoft.com/en-us/library/ms196501.aspx), который определяет настройки фильтрации для запроса.</span><span class="sxs-lookup"><span data-stu-id="bc52a-137">A  [Contains](http://msdn.microsoft.com/en-us/library/ms196501.aspx) element that defines custom filtering for the query.</span></span>|

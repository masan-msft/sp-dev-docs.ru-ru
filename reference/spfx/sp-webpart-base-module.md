...
| [`IWebPartData`](./sp-webpart-base/iwebpartdata.md)   | Эта структура представляет собой сериализованное состояние веб-части. Эта структура возвращается в результате вызова API serialize() в веб-части. Структура поля properties относится к веб-части. Каждая веб-часть можно выбрать набор свойств для сериализации.  |
